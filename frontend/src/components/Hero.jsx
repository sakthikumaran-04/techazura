...
function Hero() {
  return (
    <section className="hero min-h-screen grid grid-cols-2 max-md:grid-cols-1 max-md:grid-flow-dense place-items-center">
        <div className="flex flex-col gap-3 md:pl-10 max-sm:px-2">
            ...
            <p className="text-md text-slate-600">Experience the perfect blend of technology and creativity at TechAzura '25! From workshops, and quizzes to meme creation, short films, and gaming battles, there’s something for everyone. Showcase your skills, take on challenges, and claim victory!</p>
            <div className="flex gap-1 flex-wrap">
                ...
                <button className="border bg-blue-100 border-blue-600 max-sm:w-full text-blue-500 py-2 px-6 rounded-md flex items-center justify-center gap-3 max-sm:text-sm text-nowrap"><span>Become a Sponsor </span><FontAwesomeIcon icon={faHeart} className="text-blue-600" /></button>
            </div>
            <CountdownTimer />
